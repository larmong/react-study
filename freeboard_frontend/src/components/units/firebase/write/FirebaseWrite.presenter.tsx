import * as S from "./FirebaseWrite.style";
import { IPropsFirebaseBoardWriteUI } from "./FirebaseWrite.types";

export default function FirebaseWriteUI(props: IPropsFirebaseBoardWriteUI) {
  return (
    <S.Wrapper>
      <S.Container>
